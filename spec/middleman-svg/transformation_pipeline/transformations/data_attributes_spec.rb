...
describe Middleman::Svg::TransformPipeline::Transformations::DataAttributes do
  it "adds a data attribute to a SVG document" do
    document = Nokogiri::XML::Document.parse('<svg>Some document</svg>')
    transformation = Middleman::Svg::TransformPipeline::Transformations::DataAttributes.create_with_value({some: "value"})
  ...
  it "dasherizes the data attribute name" do
    document = Nokogiri::XML::Document.parse('<svg>Some document</svg>')
    transformation = Middleman::Svg::TransformPipeline::Transformations::DataAttributes.create_with_value({some_name: "value"})
  ...
  it "dasherizes a data attribute name with multiple parts" do
    document = Nokogiri::XML::Document.parse('<svg>Some document</svg>')
    transformation = Middleman::Svg::TransformPipeline::Transformations::DataAttributes.create_with_value({some_other_name: "value"})
  ...
  context "when multiple data attributes are supplied" do
    it "adds data attributes to the SVG for each supplied value" do
      document = Nokogiri::XML::Document.parse('<svg>Some document</svg>')
      transformation = Middleman::Svg::TransformPipeline::Transformations::DataAttributes.
