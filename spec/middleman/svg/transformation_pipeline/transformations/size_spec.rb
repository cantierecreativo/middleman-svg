...
describe Middleman::Svg::TransformPipeline::Transformations::Size do
  it "adds width and height attributes to a SVG document" do
    ...
    transformation = Middleman::Svg::TransformPipeline::Transformations::Size.create_with_value("5% * 5%")
  ...
  it "adds the same width and height value when only passed one attribute" do
    document = Nokogiri::XML::Document.parse('<svg>Some document</svg>')
    transformation = Middleman::Svg::TransformPipeline::Transformations::Size.create_with_value("5%")
